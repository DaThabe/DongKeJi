...
public partial class UserDashboardObservableViewModel(
    IContentDialogService contentDialogService,
    ILogger<UserDashboardObservableViewModel> logger,
    ISnackbarService snackbarService,
    IUserService userService,
    ICoreContext coreContext) : LazyInitializeObservableViewModel
{
    /// <summary>
    ///     当前登录用户
    /// </summary>
    ...
    private async Task ReloadAsync()
    {
        try
        {
            ...
            SelectedUser = UserCollection.FirstOrDefault() ?? UserViewModel.Default;
        }
        catch (Exception ex)
        {
