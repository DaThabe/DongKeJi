...
internal class PerformanceRecordDbContext() : DatabaseContext("PerformanceRecord")
{
    /// <summary>
    ///     员工
    /// </summary>
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfigurationsFromAssembly(typeof(PerformanceRecordDbContext).Assembly);
    }
}