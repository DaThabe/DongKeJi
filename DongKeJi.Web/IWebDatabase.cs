...
[Inject(ServiceLifetime.Singleton, typeof(IWeDatabase))]
internal class WeDatabase(IServiceProvider services) : IWeDatabase
{
...
{
    private static IAutoUpdateBuilder<TViewModel> AutoUpdate<TEntity, TViewModel>(this IWeDatabase db, TViewModel viewModel)
    ...
    public static IAutoUpdateBuilder<PageViewModel> AutoUpdate(this IWeDatabase db, PageViewModel vm)
